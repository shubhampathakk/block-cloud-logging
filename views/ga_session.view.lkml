...
map_layer: us_counties_topo {
  file: "/us_counties.json"
}
explore: ga_session {
  hidden: yes
    join: ga_session__hits {
      view_label: "Ga Session: Hits"
      sql: LEFT JOIN UNNEST(${ga_session.hits}) as ga_session__hits ;;
      relationship: one_to_many
    }
    join: ga_session__custom_dimensions {
      view_label: "Ga Session: Customdimensions"
      sql: LEFT JOIN UNNEST(${ga_session.custom_dimensions}) as ga_session__custom_dimensions ;;
      relationship: one_to_many
    }
    join: ga_session__hits__product {
      view_label: "Ga Session: Hits Product"
      sql: LEFT JOIN UNNEST(${ga_session__hits.product}) as ga_session__hits__product ;;
      relationship: one_to_many
    }
    join: ga_session__hits__promotion {
      view_label: "Ga Session: Hits Promotion"
      sql: LEFT JOIN UNNEST(${ga_session__hits.promotion}) as ga_session__hits__promotion ;;
      relationship: one_to_many
    }
    join: ga_session__hits__custom_metrics {
      view_label: "Ga Session: Hits Custommetrics"
      sql: LEFT JOIN UNNEST(${ga_session__hits.custom_metrics}) as ga_session__hits__custom_metrics ;;
      relationship: one_to_many
    }
    join: ga_session__hits__custom_variables {
      view_label: "Ga Session: Hits Customvariables"
      sql: LEFT JOIN UNNEST(${ga_session__hits.custom_variables}) as ga_session__hits__custom_variables ;;
      relationship: one_to_many
    }
    join: ga_session__hits__custom_dimensions {
      view_label: "Ga Session: Hits Customdimensions"
      sql: LEFT JOIN UNNEST(${ga_session__hits.custom_dimensions}) as ga_session__hits__custom_dimensions ;;
      relationship: one_to_many
    }
    join: ga_session__hits__experiment {
      view_label: "Ga Session: Hits Experiment"
      sql: LEFT JOIN UNNEST(${ga_session__hits.experiment}) as ga_session__hits__experiment ;;
      relationship: one_to_many
    }
    join: ga_session__hits__publisher_infos {
      view_label: "Ga Session: Hits Publisher Infos"
      sql: LEFT JOIN UNNEST(${ga_session__hits.publisher_infos}) as ga_session__hits__publisher_infos ;;
      relationship: one_to_many
    }
    join: ga_session__hits__product__custom_metrics {
      view_label: "Ga Session: Hits Product Custommetrics"
      sql: LEFT JOIN UNNEST(${ga_session__hits__product.custom_metrics}) as ga_session__hits__product__custom_metrics ;;
      relationship: one_to_many
    }
    join: ga_session__hits__product__custom_dimensions {
      view_label: "Ga Session: Hits Product Customdimensions"
      sql: LEFT JOIN UNNEST(${ga_session__hits__product.custom_dimensions}) as ga_session__hits__product__custom_dimensions ;;
      relationship: one_to_many
    }
}
view: ga_session {
  sql_table_name: `pso-gdc-japac-wedevelop-df.security_logs.ga_session` ;;
  ...
  dimension: geo_network__city {
    ...
    map_layer_name: us_counties_topo
  ...
  dimension: geo_network__country {
    ...
    drill_fields: [geo_network__city,geo_network__region]
    group_label: "Geo Network"
  ...
  dimension: geo_network__region {
    ...
    drill_fields: [totals__new_visits]
    group_label: "Geo Network"
...
view: ga_session__hits {
  ...
  dimension: ga_session__hits {
    type: string
    hidden: yes
    sql: ga_session__hits ;;
  }
...
view: ga_session__custom_dimensions {

  dimension: ga_session__custom_dimensions {
    type: string
    hidden: yes
    sql: ga_session__custom_dimensions ;;
  }
  dimension: index {
    type: number
    sql: index ;;
...
view: ga_session__hits__product {
...
view: ga_session__hits__promotion {
...
view: ga_session__hits__custom_metrics {
...
view: ga_session__hits__custom_variables {
...
view: ga_session__hits__custom_dimensions {
...
view: ga_session__hits__experiment {
...
view: ga_session__hits__publisher_infos {
...
view: ga_session__hits__product__custom_metrics {
...
view: ga_session__hits__product__custom_dimensions {
